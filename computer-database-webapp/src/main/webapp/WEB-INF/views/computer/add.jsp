                    ...
                    <form action="addComputer" method="POST">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-<servlet>
...
</servlet>control" id="discontinued" name="discontinued" placeholder="Discontinued date" data-validation="date" data-validation-format="yyyy-mm-dd">
                            </div>
                            <div class="form-group">
